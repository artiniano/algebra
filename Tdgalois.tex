...
\begin{proposition} Sean $E_{1}/K_{1}$, $E_{2}/K_{2}$ extensiones, y $\sigma \colon E_{1} \longrightarrow E_{2}$ un isomorfismo de cuerpos. Si $K_{2} = \sigma (K_{1})$, entonces $$|E_{1}:K_{1}| = |E_{2}:K_{2}|.$$
\end{proposition}
...
\begin{proposition}Sea $K\subseteq L \subseteq E$. Si $E/K$ es de Galois, $E/L$ es de Galois.
\end{proposition}
\emph{Demostración: }
