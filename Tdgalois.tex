...
\begin{definition}Consideremos la acción $$\begin{array}{rccl}
...
\begin{theorem}[\textit{\textbf{Ecuación de las clases de conjugación de un grupo}}]
