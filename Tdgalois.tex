...
\begin{proposition}Sea $E/K$ de Galois. Entonces $C_{E}(Gal(E/K)) = K$.
\end{proposition}
...
\begin{proposition}Sea $E/K$ extensión de Galois y $H \leq Gal(E/K)$. Entonces $Gal(E/C_{E}(H)) = H.$
\end{proposition}
\emph{Demostración: }Claramente $H \leq Gal(E/C_{E}(H))$. Por~~, $E/C_{E}(H)$ es de Galois. Por~~, $|Gal(E/C_{E}(H))| = |E:C_{E}(H)|$. Así, $|H| \leq |E:C_{E}(H)|$. Bastará ver que $|E:C_{E}(H)|\leq |H|$.
...
\begin{proposition} Sea $K \subseteq L \subseteq E$. Sea $H = Gal(E/L) \leq Gal(E/K)$. Dado un $\tau \in Gal(E/K)$ entonces $H^\tau = Gal(E/\tau(L))$.
\end{proposition}
