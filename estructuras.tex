...
\end{enumerate}
Y esto es así ya que, al cumplirse $b.$ y esta nueva condición, tendremos que dados $x,y \in I$ $$x-y = x +(-1)y \in I$$ (ya que $(-1)y \in I$ por $b.$). Así, $I$ será subgrupo para la suma. Estas dos últimas condiciones son las que dió en su momento el matemático Richard Dedekind cuando definió el concepto de ideal (la primera es de Kummer).
\end{definition}
...
Sea $A$ un anillo conmutativo y unitario, y supongamos que $a \in R$. Entonces, la aplicación $$\begin{array}{rccl}
...
\end{proposition}
\emph{Demostración: } Sea $I \subseteq A$ un ideal que contiene al ideal principal $(a)$, generado por el elemento irreducible $a$. Veamos que ó bien $I = (a)$ ó $I = A$. Pero por ser $A$ un $DIP$, existirá un $b \in A$ tal que $I = (b)$. En consecuencia, $(a) \subset I = (b)$ y $b \mid a$. Como $a$ es irreducible, tendremos dos opciones: \begin{enumerate}
...
Primero, el resultado central del capítulo, y a partir del cual desarrollaremos el resto.
